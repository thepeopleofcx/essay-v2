...
export const timelineEpochs: TimelineEpoch[] = [
  { id: "e1", era: "Hunter-Gatherers", period: "~300,000 years", description: "Foraging and subsistence dominated human labor.", shift: "Estimated subsistence labor: 15-20 hours/week." },
  { id: "e2", era: "Agrarian Society", period: "~10,000 years", description: "Agriculture scaled population and institutions.", shift: "80-90% of people engaged in food production." },
  { id: "e3", era: "Industrial Revolution", period: "~250 years", description: "Factory transition caused severe pain before long-run gains.", shift: "Life expectancy rose and work hours fell over time." },
  { id: "e4", era: "Knowledge Work", period: "~50-70 years", description: "Professional and service jobs expanded rapidly.", shift: "Services now account for roughly 77% of GDP." },
  { id: "e5", era: "The Unknown", period: "Beginning now", description: "AI transition is underway and accelerating.", shift: "Outcome depends on adaptation quality." },
];
